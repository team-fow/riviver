...
var not_erodible: Array[Tile.Type] = [Tile.Type.RIVERBED, Tile.Type.SHALLOW_WATER, Tile.Type.DEEP_WATER, Tile.Type.WORLDTREE, Tile.Type.WORLDTREE_SAPLING, Tile.Type.LIBRARY]
